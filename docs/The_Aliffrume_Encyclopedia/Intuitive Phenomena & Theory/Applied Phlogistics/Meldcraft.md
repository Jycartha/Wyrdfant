...
More than any other school of firekeeping, meldcraft relies heavily on [Kindlegem](/The_Aliffrume_Encyclopedia/Technology/Kindlegem.md) improved over many generations and kept as close family secrets, due to the incredibly precise nature of molecular structure. A common way the problem is simplified is with the granular model, which simplifies materials into discrete granules to be managed. With this method, the mark of skill is the “resolution” of a work, or how small the granules can be made.
