...
### Soul Plane
Where most of a soul's engrammatic mass is actually concentrated, as an inherent "density" of the plane. While typically contained entirely within the soul wall, after the advent of [dynamic space theory](Dynamic%20Space%20Theory.md) and [field equivalence](Conscious%20Plane.md#Field%20Equivalence), it has been shown that sufficient concentrations of [soulfire](Soulfire.md) are indistinguishable from the inner soul plane. In particular, a [soulplane projection](../Soulfire/Ichor.md#Soulplane%20Projection) is often precisely a case of the soul plane being made external to the main corpus.
