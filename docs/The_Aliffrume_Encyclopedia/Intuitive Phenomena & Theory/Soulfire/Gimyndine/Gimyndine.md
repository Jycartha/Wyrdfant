...
## Gimyndization
Matter can be converted into gimyndine if overinfused or subjected to intense infusion shock, referred to as gimyndization. According to the [phlogistic model](../../Pure%20Phlogistics/Phlogistic%20Model.md), this occurs when the volume of soulfire in some matter exceeds the volume of the atom causing it to essentially supplant it and take on a more permanent form. Notably, the process is irreversible, as it causes the overwhelmed matter to deconstruct into the soulfire itself, causing it to become the hybrid material that is gimyndine.
