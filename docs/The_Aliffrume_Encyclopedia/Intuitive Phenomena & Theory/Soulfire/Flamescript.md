...
Upon completion of this process, the soulfire will infuse upon the surface in a unique engrammatic construction with varying amounts of [spin](Interactions/Spin%20Friction.md). From this point onwards, soulfire which contacts the infused flamescript follows the form of the encoded engram automatically, while remaining under the infuser’s control. The manipulation of an active engram and soulfire is a separate skill, however, and left to [flamebearers](../../Glossary.md#Flamebearer).

It should be noted that if a flamescribe possesses sufficient skill, the process of transcription can occur with much less than complete focus, and flamescript can be encoded briefly upon the body, allowing for scripts to be "remembered" in the short term. This process is much more straightforward for those with an [ichorous corpus](Ichor.md), who can simply embed engrams directly into their body as the underlying structure of the ichor, the foundation of the [[divinity market]]
