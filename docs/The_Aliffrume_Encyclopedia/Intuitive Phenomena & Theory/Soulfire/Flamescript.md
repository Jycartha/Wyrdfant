...
Upon completion of this process, the soulfire will infuse upon the surface in a unique engrammatic construction with varying amounts of [spin](Interactions/Spin%20Friction.md). From this point onwards, soulfire which contacts the infused flamescript follows the form of the encoded engram automatically, while remaining under the infuser’s control, allowing for the rapid reconstruction of complex soulfire machinery. The manipulation of an active engram and soulfire is a separate skill, however, and left to [flamebearers](../../Glossary.md#Flamebearer).

### Permanence
It should be noted that if a flamescribe possesses sufficient skill, the process of transcription can occur with much less than complete focus, and flamescript can be encoded briefly upon the body, allowing for scripts to be "remembered" in the short term. This process is much more straightforward and long-lasting for those with an [ichorous](../../Glossary.md#Ichorous) corpus, who can simply embed engrams directly into their body as the underlying structure of the [ichor](Ichor.md); this is the foundation of corporeal [ichorware](../../Technology/Highflame%20Instruments/Ichorware.md).

## Form
The form of flamescript varies heavily, due to their origin in the myriad thoughts of sapients. Those engraved using dyed gimynfire contain idiosyncratic circular patterns, the system used by the Hytheans to describe reality in mathematical notation. Flamescript burned by a [soulkeeper](../Applied%20Phlogistics/Soulkeeping.md), on the other hand, takes on a more chaotic and inconsistent shape that carries an uncanny beauty nonetheless.
