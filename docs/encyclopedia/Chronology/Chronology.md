...
The origin point for many nations, each for separate reasons. Each reason, however, has its roots in when the local discovery of gimyndine’s use in [scriptlighting](<The Phlogistic Model.md#Flamescript>) took place. For some this means a legendary inventor creating marvels of technology, for others it means the appearance of royally powerful flamebearers. But curiously, all of these “first contacts” with modern firekeeping were recorded to occur within the same cycle, a fact currently explained as coincidence.
